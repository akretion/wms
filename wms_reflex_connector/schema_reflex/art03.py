...
# In this file it is important to only have ReflexLine classes
# and ReflexLineData dataclasses
# The module definition is used in the models to retrieve ReflexLineData classes
# from their corresponding ReflexLine class
# This is so that custom module can list their needed ReflexLine
...
class ReflexLine03110(ReflexLine):
    def __init__(self, reflex_line_data: ReflexLine03110Data):
        super().__init__()
    ...
    def get_values(self):
        ...
        return [
            ...
            ("Top article nouveau", 1, data.update),
        ]
...
class ReflexLine03120(ReflexLine):
    ...
    def get_values(self):
        ...
        return [
            ...
            ("Top contrôle à réception", 1, data.flag_receipt_control),
            (

...
export var MoveToProductionStatesMixin = {
    data: function () {
        return {
            states: {
...
const MoveToProduction = {
    mixins: [ScenarioBaseMixin, MoveToProductionStatesMixin],
    template: `
...
process_registry.add("move_to_production", MoveToProduction);

export default MoveToProduction;

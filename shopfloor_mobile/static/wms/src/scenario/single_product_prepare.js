...
export var SingleProductPrepareStatesMixin = {
    data: function() {
        return {
            states: {
...
const SingleProductPrepare = {
    mixins: [ScenarioBaseMixin, SingleProductPrepareStatesMixin],
    template: `
...
process_registry.add("single_product_prepare", SingleProductPrepare);

export default SingleProductPrepare;

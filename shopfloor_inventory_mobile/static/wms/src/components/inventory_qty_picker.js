...
export var InventoryQtyPickerMixin = {
    props: {
        options: Object,
    },
    data: function () {
...
export var InventoryQtyPicker = Vue.component("inventory-qty-picker", {
    mixins: [InventoryQtyPickerMixin],
    props: {
        readonly: Boolean,
    },
    data: function () {
...
export var InventoryQtyPickerDisplay = Vue.component("inventory-qty-picker-display", {
    mixins: [InventoryQtyPickerMixin],
    methods: {
